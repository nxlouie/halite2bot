...
game = hlt.Game("Fast Settler")
# Then we print our start message to the logs
logging.info("Starting Fast Settler Bot!")
        ...
        for distance in sorted(entities_by_distance):
            ...
            if nearest_planet:
                ...
                if ship.can_dock(nearest_planet):
                    ...
                    # (by using closest_point_to)
                    # with constant speed. Don't worry about pathfinding for now, as the command will do it for you.
                    # We run this navigate command each turn until we arrive to get the latest move.
                    # Here we move at half our maximum speed to better control the ships
                    # In order to execute faster we also choose to ignore ship collision calculations during navigation.
                    # This will mean that you have a higher probability of crashing into ships, but it also means you
                    # will make move decisions much quicker. As your skill progresses and your moves turn more optimal
                    # you may wish to turn that option off.
